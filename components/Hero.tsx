      ...
      <div className="relative z-10 max-w-[1400px] w-full mx-auto px-8 md:px-16">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8">
          ...
          <div className="flex-1 text-center lg:text-left max-w-2xl">
            {/* Status badge */}
            <div className="hero-line animate-fade-in-up opacity-0 mb-8 flex justify-center lg:justify-start">
              <ScatterText
            ...
            {/* Name — single line */}
            <div className="hero-line animate-fade-in-up opacity-0 mb-6 flex justify-center lg:justify-start items-baseline gap-0">
              <ScatterText
                text="ASWIN"
                fontSize={50}
                color="#e0e0e0"
            ...
            {/* Role */}
            <div className="hero-line animate-fade-in-up opacity-0 mb-4 flex justify-center lg:justify-start items-center gap-2">
              <ScatterText
                text="FULL STACK"
                fontSize={18}
                color="#888888"
            ...
            {/* Description */}
            <div className="hero-line animate-fade-in-up opacity-0 mb-2.5 flex justify-center lg:justify-start">
              <ScatterText
            ...
            <div className="hero-line animate-fade-in-up opacity-0 flex flex-wrap items-center justify-center lg:justify-start gap-8">
              <a href="#work" className="group inline-block transition-all duration-300 hover:opacity-80">
                <ScatterText
                  text="VIEW WORK"
                  fontSize={14}
                  color="#00ff88"
              ...
              <a href="#contact" className="inline-block transition-all duration-300 hover:opacity-80">
                <ScatterText
                  text="GET IN TOUCH"
                  fontSize={14}
                  color="#777777"
        ...
        {/* Scroll indicator */}
        <div className="hero-line animate-fade-in-up opacity-0 absolute bottom-10 left-1/2 -translate-x-1/2">
          <button
            onClick={() => {
